        ...
        <div className="flex justify-between gap-1 w-full flex-col">
            <div className="flex justify-between">
                <div className="flex gap-1">
                    <h1 className="text-base text-slate-400 truncate max-w-[120px]">{data.product.title}</h1>
                    <span>x {data.qty}</span>
                </div>
                <h1 className="text-base text-slate-400">{toUSDCurrency(data.product.price)}</h1>
            </div>
            <div className="flex justify-between">
