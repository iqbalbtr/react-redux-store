...
const LoginForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        getLogin(data, (status, res) => {
            if (status) {
                localStorage.setItem("token", encryptData(res))
                window.location.href = "/"
            } else {
                console.log(res);
            }
    ...
    return (
        <form action="" className="bg-primary p-8 w-[400px] rounded-md text-white" ref={login} onSubmit={(e) => handleSubmit(e)}>
                ...
                <div className="flex flex-col gap-1 ">
                    ...
                    <div className="text-white relative text-black">
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            id="eye"
                            style={toggleEye ? { display: "none" } : { display: "block" }}
                            onClick={() => setToggleEye(cur => !cur)}
                        >
                        ...
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            id="eye-slash"
                            style={toggleEye ? { display: "block" } : { display: "none" }}
                            onClick={() => setToggleEye(cur => !cur)}
                        >
                            <path
